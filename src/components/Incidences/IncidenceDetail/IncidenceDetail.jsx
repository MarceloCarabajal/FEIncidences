...
import { EditModal } from 'components/Incidences/IncidenceDetail/EditModal/EditModal';
import { HistoryOfChanges } from 'components/Incidences/IncidenceDetail/HistoryOfChanges/HistoryOfChanges';
import { useDispatch, useSelector } from '../../../../node_modules/react-redux/es/exports';
import { getHistoricoCambios } from 'service/HistoricoCambios';
import CommentModal from './Comment/CommentModal';
import { ResolveIncidence } from './ResolveIncidence/ResolveIncidence';
          ...
          incidencias.map((i) => (
            ...
            <React.Fragment key={i.id}>
              ...
              <Stack direction="row" spacing={2} py={3}>
                ...
                <Button variant='outlined' onClick={handleOpen('paper')}><EditIcon fontSize='small' /><Typography pl={0.5}>Resolver Incidencia</Typography></Button>
